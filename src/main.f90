...
use, non_intrinsic :: day_07, only: solve_day_07
...
!    write(*,'(a,f0.1,a)') 'solved DAY_05 in ',real(max(c2 - c1, 1_int64), real64)/real(cr, real64)*1000.0_real64,' ms'
    ...
    call system_clock(c1, cr)
    call solve_day_07('./inputs/day_07_input.txt')
    call system_clock(c2)
    write(*,'(a,f0.1,a)') 'solved DAY_07 in ',real(max(c2 - c1, 1_int64), real64)/real(cr, real64)*1000.0_real64,' ms'
